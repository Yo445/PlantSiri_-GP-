...
export default function Gauge({
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <div  style={{ color:strokeColor,marginTop: "1.6em", fontSize: "1.5em", lineHeight: "1em", fontWeight: "600", fontFeatureSettings: "'zero', 'tnum' 1" }}>
        {value}
      </div>
      {!!units && (
        <div style={{  lineHeight: "2em", fontWeight: "400" ,fontSize: "1.5em" , color:strokeColor}}>
          {units}
        </div>
      )}
    </div>
