...
def generate_weather_data():
    ...
    data = {
        ...
        "soil_moisture": random.uniform(40, 100),  # soil_moisture (mm)
        ...
        "flow_rate": 100, # The flow rate of the irrigation system (L/s) @@ This value depends on the specific irrigation system design and pumping capacity.
    }
    return data
...
def send_data_to_kafka(producer, topic, data):
    json_data = json.dumps(data)  # Convert data dictionary to JSON string
    producer.produce(topic, key=data["sensor_id"], value=json_data, callback=delivery_report)
