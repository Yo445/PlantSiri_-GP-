...
export default function Gauge({
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <div  style={{ marginTop: "1.6em", fontSize: "1.5em", lineHeight: "1em", fontWeight: "600", fontFeatureSettings: "'zero', 'tnum' 1" }}>
        {value}
      </div>
      {!!label && (
        <div style={{ color: "#8b8ba7", marginTop: "0.6em", fontSize: "1.3em", lineHeight: "1.3em", fontWeight: "700" }}>
          {label}
        </div>
      )}
      {!!units && (
        <div className="unit" style={{  lineHeight: "2em", fontWeight: "400" ,fontSize: "1.5em"}}>
          {units}
        </div>
      )}
    </div>
