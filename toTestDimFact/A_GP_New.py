...
input_topic = 'MOSTAFA555'
output_topic = 'KARIM55'

def generate_weather_data(sensor_id, cycle, start_date, cycle_status ,latitude):
    ...
    data = {
        ...
        'altitude': 30,  # Replace with the actual altitude of your location in meters
    ...
    try:
        while True:
            ...
            try:
                ...
                if cycle_status =="OFF":
                    cycle_status="ON"
                # if(start_date <= datetime.now().date().strftime('%Y-%m-%d')):
                    # cycle_status = "ON FROM"
                # else:
                ...
                if True:
                    weather_data = generate_weather_data(sensor_id, cycle, start_date,cycle_status ,latitude)
