        ...
        >
          ...
          >
            <Button
              ...
              variant="contained"
              size="large"
              sx={{ fontSize: "18px",backgroundColor:"#7ba132",":hover":{backgroundColor:"#486118"}}}
              onClick={() => {
            ...
            <Button
              ...
              variant="contained"
              size="large"
              sx={{ fontSize: "18px" ,backgroundColor:"#edf6db",color:"#737963", ":hover":{backgroundColor:"#7ba132" , color:"#ffffff"}}}
              onClick={() => {
                io.connect(urlSend).emit("pumpmanual", {
                  path: "pumpstopmanual",
                  state: true,
